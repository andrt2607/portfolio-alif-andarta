      ...
      try {
        ...
        setProjects([
          ...
          },
          {
            ...
            description: 'Collaborative project management tool with real-time updates, file sharing, and team communication features. Supports agile workflows and sprint planning.',
            technologies: ['Vue.js', 'Express.js', 'MongoDB', 'Socket.io', 'AWS S3'],
            github_url: 'https://github.com',
            live_url: 'https://example.com',
          ...
          },
          {
            ...
            description: 'Business intelligence dashboard with interactive charts, data visualization, and automated reporting. Processes millions of data points in real-time.',
            technologies: ['React', 'D3.js', 'Python', 'FastAPI', 'ClickHouse', 'Kubernetes'],
            github_url: 'https://github.com',
            live_url: 'https://example.com',
            image_url: 'https://images.pexels.com/photos/669610/pexels-photo-669610.jpeg?auto=compress&cs=tinysrgb&w=800',
            featured: true,
          ...
          },
          {
            ...
            description: 'Machine learning-powered content generation platform that creates high-quality articles, social media posts, and marketing copy using natural language processing.',
            technologies: ['Python', 'TensorFlow', 'React', 'FastAPI', 'PostgreSQL', 'OpenAI API'],
            github_url: 'https://github.com',
            live_url: 'https://example.com',
          ...
          },
          {
            ...
            description: 'Comprehensive monitoring and alerting platform for containerized applications with custom metrics, log aggregation, and automated incident response.',
            technologies: ['Go', 'Prometheus', 'Grafana', 'Kubernetes', 'ElasticSearch', 'Docker'],
            github_url: 'https://github.com',
            live_url: 'https://example.com',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto mb-8">
            A showcase of innovative solutions and collaborative achievements that demonstrate technical excellence and business impact.
          </p>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                <img
                  src={project.image_url || 'https://images.pexels.com/photos/270348/pexels-photo-270348.jpeg?auto=compress&cs=tinysrgb&w=800'}
                  alt={project.title}
