        ...
        setEducation([
          {
            ...
            end_date: "2019-06-01",
            description:
              "Specialized in Machine Learning and Distributed Systems. Thesis on scalable microservices architecture.",
            gpa: "3.8",
          ...
          },
          {
            ...
            end_date: "2017-05-01",
            description:
              "Graduated Magna Cum Laude. Active member of the Engineering Student Council and ACM chapter.",
            gpa: "3.7",
            created_at: "2023-01-01",
          },
        ]);
          ...
          <div className="text-center">
            <div className="bg-blue-100 dark:bg-blue-900/30 border border-blue-300 dark:border-blue-700 rounded-lg p-6">
              <p className="text-blue-800 dark:text-blue-300">
                No education data found. Please add your education records.
              </p>
            </div>
          </div>
        ) : (
